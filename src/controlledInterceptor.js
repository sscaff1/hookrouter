 ...
 * `confirmNavigation` is the callback to be called to stop the interception and navigate
 *  to the last path. `resetPath` is a callback that resets `interceptedPath` back to `null`.
 *
 * @returns {Array} [interceptedPath, confirmNavigation, resetPath]
 */
const useControlledInterceptor = () => {
...
export default useControlledInterceptor;
